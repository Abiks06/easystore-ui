...
export default function Footer() {
  return (
    <footer className="anim-fade-up bg-gradient-to-b from-gray-100 to-white border-t border-gray-200 shadow-sm flex items-center justify-center gap-2 px-4 py-5 text-sm text-gray-500">
